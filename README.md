...
6. Executes all newly-added or targeted scripts in document order.
...
- Executes all newly-added or targeted scripts in document order, and wait for the blocking ones (e.g., inline scripts).
